...
class RTCFormatPropertyPack : public DiControlPropertyPack
{
public:
	RTCFormatPropertyPack();
	virtual ~RTCFormatPropertyPack();
	
	IRTCFormat* Control() { return dynamic_cast<IRTCFormat*>(__super::Control());}
...
class QRCodePropertyPack: public MultiCtrlPropertyPack
{
public:
	QRCodePropertyPack();
	virtual~ QRCodePropertyPack();
