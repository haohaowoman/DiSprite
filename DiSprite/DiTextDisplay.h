...
namespace DiControl
{
	interface IRTCFormat
	{
		virtual CString RTCFormat() const = 0;
		virtual void RTCFormat(const CString& val) = 0;
	};
	...
	public:
		...
		virtual CString RTCFormat() const;

		virtual void RTCFormat(const CString& val);
